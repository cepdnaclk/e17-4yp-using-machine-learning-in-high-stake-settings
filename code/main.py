...
trained_model, eval_metrics, avg_metrics = fe.run_pipeline(data, classifier_1, "logistics_regression/" ,dest = f"./run/LogisticRegression")
...
# save_model(file_name=f'SVM_{str(time.strftime("%Y-%m-%d %H:%M:%S"))[:10]}.sav', model=trained_model)
